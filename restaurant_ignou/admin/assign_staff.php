...
if (isset($_GET['orderId'])) {
    ...
    exit; // Exit the script if order ID is not provided
}

if (isset($_POST['submit'])) {
    $selectedStaffId = $_POST['assignStaff'];

    $update_query = "UPDATE orders SET assigned_staff_id = ? WHERE orderid = ?";
    $stmt = mysqli_prepare($con, $update_query);
    mysqli_stmt_bind_param($stmt, 'ii', $selectedStaffId, $orderId);
    if (mysqli_stmt_execute($stmt)) {
       
        echo '<script>alert("Staff assigned successfully!");</script>'; // Alert upon successful assignment
    } else {
  ...
  <div id="wrapper">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                            ...
                                            <input class="form-control" name="orderId" type="text" value="<?php echo $orderId; ?>">
    ...
    <select class="form-control" name="assignStaff" id="assignStaff">
        ...
        while ($staff_row = mysqli_fetch_assoc($staff_result)) {
            ...
            $fullName = $staff_row['fname'] . ' ' . $staff_row['lname'];
            echo "<option value='" . $staff_row['staffid'] . "'>" . $fullName . "</option>";
        }
        ?>
    </select>
</div>
 <button type="submit" name="submit" class="btn btn-danger">Assign </button>
</form>
