...
<body>
   <div id="wrapper">
    ...
    <li>
        <a class="active-menu" href="view_payments.php"><i class="fa fa-money"></i> View Payments</a>
    </li>
     <li>
    <a href="view_reviews.php"><i class="fa fa-comments"></i> View Reviews</a>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">VIEW Payments</h1>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><?php echo $row["pay_id"]; ?></td>
...
<td align="center"><?php echo $row["qnty"]; ?></td>
<td align="center"><?php echo $row["restaurant_name"]; ?></td>
<td align="center"><?php echo $row["tot_amount"]; ?></td>
<td align="center"><?php echo $row["status"]; ?></td>
<td align="center"><?php echo $row["paid_date"]; ?></td>
