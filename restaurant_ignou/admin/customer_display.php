...
<body>
    ...
    <li>
        <a class="active-menu" href="customer_display.php"><i class="fa fa-users"></i> View Customers</a>
    </li>
    <li>
    ...
    <a href="view_reviews.php"><i class="fa fa-comments"></i> View Reviews</a>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">VIEW CUSTOMER DETAILS</h1>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <a href="customer_del.php?customerid=<?php echo $row["customerid"]; ?>">Delete</a>
                                            </td>
