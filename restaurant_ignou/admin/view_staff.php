...
<body>
   <div id="wrapper">
    ...
    <li>
        <a class="active-menu" href="view_staff.php"><i class="fa fa-users"></i> View Staffs</a>
    </li>
    <li>
    ...
    <a href="view_reviews.php"><i class="fa fa-comments"></i> View Reviews</a>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">VIEW Staffs</h1>
...
<td align="center"><?php echo $row["staff_position"]; ?></td>
<td align="center">
                                                <a href="staff_del.php?staffid=<?php echo $row["staffid"]; ?>">Delete</a>
                                            </td>
