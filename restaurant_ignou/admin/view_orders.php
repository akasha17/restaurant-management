...
<body>
  <div id="wrapper">
    ...
    <li>
        <a class="active-menu" href="view_orders.php"><i class="fa fa-shopping-cart"></i> View Orders</a>
    </li>
    <li>
    ...
    <a href="view_reviews.php"><i class="fa fa-comments"></i> View Reviews</a>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">VIEW Orders</h1>
...
<td align="center"><?php echo $row["restaurant_id"]; ?></td>
<td align="center"><?php echo $row["orderstatus"]; ?></td>
<td align="center"><?php echo $row["payment_status"]; ?></td>  
<td align="center">
    <button onclick="assignOrder(<?php echo $row['orderid']; ?>)">Assign</button>
</td>
<td align="center"><?php echo $row["assigned_staff_id"]; ?></td>
    ...
    // Redirect to assign_staff.php with order ID as parameter
    window.location.href = 'assign_staff.php?orderId=' + orderId;
}
