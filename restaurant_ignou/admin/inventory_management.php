...
$productQuery = "SELECT item_id, name FROM menu";
...
if(isset($_POST['submit']))
{
    ...
    $q="insert into inventory(item_id,item_name,quantity,record_threshold)values('$item_id','$item_name','$qnty','$rec')";
...
<body>
    ...
    <li>
        ...
        <ul class="nav nav-second-level">
            ...
            <li>
                <a class="active-menu" href="inventory_management.php"><i class="fa fa-eye"></i> View Inventory</a>
            </li>
        </ul>
    </li>
    <li>
    ...
    <a href="view_reviews.php"><i class="fa fa-comments"></i> View Reviews</a>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Inventory Management</h1>
                    </div>
                    <div class="col-md-12">
                     <!--   Basic Table  -->
    ...
    <tbody>
        <?php
        $count = 1;
        // SQL query to join the inventory and restaurants tables
        $sel_query = "SELECT i.item_id, i.item_name, i.quantity, i.record_threshold, r.name 
                      FROM inventory i 
        ...
        <tr>
            ...
            <td align="center"><?php echo $row["record_threshold"]; ?></td>
            <td align="center">
                <a href="inventory_edit.php?id=<?php echo $row["item_id"]; ?>">Edit</a>
            </td>
            <td align="center">
                <a href="inventory_del.php?id=<?php echo $row["item_id"]; ?>">Delete</a>
            </td>
        </tr>
        <?php $count++; } ?>
    </tbody>
