...
<li>
    <a   class="active-menu" href="view_restaurants.php"><i class="fa fa-store"></i> Restaurants</a>
</li>
<li>
...
<li>
    ...
    <tbody>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            $file_path = '../admin/' . $row['image']; // Adjust the path based on the directory structure
        ?>
            <tr>
