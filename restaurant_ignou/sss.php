...
if(isset($_POST['submit'])) {
    ...
    foreach ($selectedItems as $selectedItem) {
        ...
        // Get restaurant name from hidden fields
        ...
        $insertOrderQuery = "INSERT INTO orders (customer_id, item_id, rest_name, quantity, subtotal, total, orderstatus, payment_status, order_date, order_time)
                             VALUES ('$customer_id', '$itemId', '$restaurantName', '$quantity', '$subtotal', '$totalAmount', 'Confirmed', 'Pending', '$orderDate', '$orderTime')";
