...
$orderDetails = array();
$totalAmount = 0; // This will hold the final total amount of the order
...
if (isset($_POST['submit'])) {
    ...
    foreach ($selectedItems as $key => $selectedItem) {
        ...
        // Add to the total amount (subtotal * quantity)
    ...
    foreach ($selectedItems as $key => $selectedItem) {
        ...
        // Use $totalAmount which is the sum of all items' subtotals
