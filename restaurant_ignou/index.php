...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" integrity="sha512-xKsTOp8w86o1ITLK1PUaXOd8XUI8y0pjoQ8HGv9rS7txC+UTivJ0AFtZ+Yeu8q+MHcLzR0xq14dFVnYK3cczBw==" crossorigin="anonymous" referrerpolicy="no-referrer" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="slider_cont">
                                                ...
                                                <a class="main_bt_border" href="recipe.php">Order Now</a>
                                            </div>
                                        </div>
                                        <div class="col-md-7">
            ...
            <div class="owl-carousel owl-theme">
                ...
                <div class="item">
                    <div class="product_blog_img">
                        <img src="admin/<?php echo $file_path; ?>" alt="#" style="height: 212.92px;width: 214px;" />
                    </div>
                    <div class="product_blog_cont">
                        <h3><?php echo $row['name']; ?></h3>
                        <h4><span class="theme_color">&#8377;</span><?php echo $row['price']; ?></h4>
                    </div>
                </div>
                 <?php
                }
      ...
      <div class="row">
       ...
       <div class="row">
         ...
         <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
            <div class="about_box">
                 <h3>Best Food</h3>
                 <p>Step into our warm and inviting ambiance, where contemporary design meets timeless elegance. Whether you're here for an intimate dinner, a family celebration, or a business gathering, our attentive and knowledgeable staff is dedicated to making your dining experience truly exceptional. We take pride in providing impeccable service that complements the outstanding cuisine we serve. </p>
                 
             </div>
         </div>
          <div class="col-xl-5 col-lg-5 col-md-10 col-sm-12 about_img_boxpdnt">
             <div class="about_img">
                 <figure><img src="images/about-img.jpg" style="width: 348.66 px; height: 310.64 px;" alt="#/"></figure>
             </div>
         </div>      
       </div> 
    </div>
...
<div class="blog">
  <div class="container">
    ...
    <div class="row">
      <?php
      $query = "SELECT * FROM restaurants LIMIT 3"; // Limiting to 3 rows
      $result = mysqli_query($con, $query);
      ...
      <div class="col-md-12" style="text-align: center;">
          <a href="restaurants_view.php" class="btn btn-primary">More Restaurants</a>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="row">
      <div class="col-md-6 offset-md-3">
         <div class="Client_box">
           ...
           <h3>Arjun</h3>
           <p>The food was authentic and delicious. The menue is reasonably priced and the portion was generous, I couldn’t finish up my plate and ended up asking for a box to takeout. Employees were super nice and welcoming. Will visit this place again!.</p>
