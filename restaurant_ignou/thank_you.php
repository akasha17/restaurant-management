...
if (isset($_GET['restaurant_name']) && isset($_GET['restaurant_id'])) {
    $restaurantName = htmlspecialchars($_GET['restaurant_name']);
    $restaurantId = htmlspecialchars($_GET['restaurant_id']);
} else {
...
<body class="main-layout blog_page">
    ...
    <p>Restaurant Name: <?php echo $restaurantName; ?></p>
    <p>Restaurant ID: <?php echo $restaurantId; ?></p>
    </div>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["feedback"]) && $_POST["feedback"] == "yes") {
        ...
        echo '<form action="sub_feed.php" method="post">';
